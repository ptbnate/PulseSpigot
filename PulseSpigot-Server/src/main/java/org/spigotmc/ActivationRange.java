...
public class ActivationRange
{
     ...
     */
    public static boolean initializeEntityActivationState(Entity entity, WorldConfig config)
    {
    ...
    {
        final int miscActivationRange = world.spigotConfigPulseSpigot.entityActivationRange.ambient;
        final int animalActivationRange = world.spigotConfigPulseSpigot.entityActivationRange.animals;
        final int monsterActivationRange = world.spigotConfigPulseSpigot.entityActivationRange.monsters;

        int maxRange = Math.max( monsterActivationRange, animalActivationRange );
        maxRange = Math.max( maxRange, miscActivationRange );
        maxRange = Math.min( ( world.spigotConfigPulseSpigot.viewDistance << 4 ) - 8, maxRange );
        ...
        for ( Entity player : (List<Entity>) (List) world.players )
        {
            ...
            for ( int i1 = i; i1 <= j; ++i1 )
            {
                ...
                {
                    // PulseSpigot start - don't look chunks twice
