...
public class AntiXray
{
    ...
    // PulseSpigot start
    public AntiXray(WorldConfig.AntiXray config) {
        // Set all listed blocks as true to be obfuscated
    ...
    {
        if ( world.spigotConfigPulseSpigot.antiXray.enabled && !pendingUpdates.isEmpty() )
        {
            queueUpdates = false;
    ...
    {
        if ( world.spigotConfigPulseSpigot.antiXray.enabled )
        {
            // PaperSpigot start
            if ( queueUpdates )
            {
                        ...
                        for ( int z = 0; z < 16; z++ )
                        {
                            for ( int x = 0; x < 16; x++ )
                            {
                                ...
                                if ( obfuscateBlocks[blockId] )
                                {
                                    ...
                                    {
                                        int newId = blockId;
                                        switch ( world.spigotConfigPulseSpigot.antiXray.engineMode )
                                        {
                                            case 1:
