...
public class SpigotConfig
{
    ...
    public static Map<String, Integer> forcedStats = new HashMap<String, Integer>(); // PulseSpigot - use java map, if ever needed bring back TObjectIntHashMap for compatibility
