...
public final class Config extends EngineConfig<WorldConfig> {
    ...
    public Map<String, xyz.krypton.spigot.config.WorldConfig> worldSettings = new HashMap<>();

    @Override
    public @NotNull Map<String, xyz.krypton.spigot.config.WorldConfig> getWorldConfigs() {
        return this.worldSettings;
    }

    @Override
    protected @NotNull xyz.krypton.spigot.config.WorldConfig createDefaultWorldConfig() {
        return new xyz.krypton.spigot.config.WorldConfig();
    }
