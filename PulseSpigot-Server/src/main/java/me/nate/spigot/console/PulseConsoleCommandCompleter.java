package me.nate.spigot.console;
...
public class PulseConsoleCommandCompleter implements Completer {
    private final DedicatedServer server;

    public PulseConsoleCommandCompleter(DedicatedServer server) {
        this.server = server;
    }
    ...
    private class CompletionWaiter extends Waitable<List<String>> {
        ...
        @Override
        protected List<String> evaluate() {
            final CraftServer server = PulseConsoleCommandCompleter.this.server.server;
