...
public class EntityPotion extends EntityProjectile {
    ...
    protected float m() {
        return PulseSpigot.get().getMotionHandler().getPotionFallSpeed();
    }

    protected float j() {
        return (float) PulseSpigot.get().getMotionHandler().getPotionSpeed();
    }

    protected float l() {
        return PulseSpigot.get().getMotionHandler().getPotionOffset();
    }
