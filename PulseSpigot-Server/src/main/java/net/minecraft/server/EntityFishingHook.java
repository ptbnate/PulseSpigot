...
public class EntityFishingHook extends Entity {
    ...
    public EntityFishingHook(World world, EntityHuman entityhuman) {
        ...
        c(this.motX, this.motY, this.motZ, (float) knockbackProfile.getRodSpeed(), 1.0F); // PulseSpigot
    }
    ...
    public void t_() {
        ...
        if (this.az > 0) {
            ...
            if (movingobjectposition != null) {
                org.bukkit.craftbukkit.event.CraftEventFactory.callProjectileHitEvent(this, movingobjectposition.entity, movingobjectposition.a(), movingobjectposition.direction); // Craftbukkit - Call event // PulseSpigot - Backport methods
                ...
                if (!this.world.isClientSide && d7 > 0.0D) {
                    ...
                    if (this.av > 0) {
                        ...
                        if (this.ax > 0) {
                            ...
                            this.aw = MathHelper.nextInt(this.random, this.world.paperConfigPulseSpigot.fishingTimeRange.minimumTicks, this.world.paperConfigPulseSpigot.fishingTimeRange.maximumTicks); // PaperSpigot - Configurable fishing tick range
