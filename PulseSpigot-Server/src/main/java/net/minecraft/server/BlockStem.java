...
public class BlockStem extends BlockPlant implements IBlockFragilePlantElement {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.isLightLevel(blockposition.getX(), blockposition.getY() + 1, blockposition.getZ(), 9)) { // Paper // PulseSpigot
            ...
            if (random.nextInt((int) (world.growthOdds / (this == Blocks.PUMPKIN_STEM? world.spigotConfigPulseSpigot.growth.pumpkinModifier : world.spigotConfigPulseSpigot.growth.melonModifier) * (25.0F / f)) + 1) == 0) { // Spigot
