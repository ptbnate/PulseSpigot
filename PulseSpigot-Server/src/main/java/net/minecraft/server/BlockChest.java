...
public class BlockChest extends BlockContainer {
    ...
    // PulseSpigot end
            ...
            } while (world.getType(x, y, z, enumdirection).getBlock() != this); // PulseSpigot
    ...
    public int a(IBlockAccess iblockaccess, int x, int y, int z, IBlockData iblockdata, EnumDirection enumdirection) { // PulseSpigot
        if (!this.isPowerSource()) {
            ...
            int i = 0;
            TileEntity tileentity = iblockaccess.getTileEntity(x, y, z); // PulseSpigot
    ...
    private boolean p(World world, BlockPosition blockposition) {
        ...
        if (world.paperConfigPulseSpigot.gameMechanics.disableChestCatDetections) {
            return false;
        }
        // PaperSpigot end
