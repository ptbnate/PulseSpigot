...
public class ServerPing {
    ...
    public ServerPing.ServerPingPlayerSample getPlayers() { return this.b(); } // PulseSpigot - OBFHELPER
    ...
    public ServerPing.ServerData getVersion() { return this.c(); } // PulseSpigot - OBFHELPER
    ...
    public static class ServerData {
        ...
        public int getProtocol() { return this.b(); } // PulseSpigot - OBFHELPER
        public int b() {
            return this.b;
        }
    ...
    public static class ServerPingPlayerSample {
        ...
        public void setSample(GameProfile[] sample) { this.a(sample); } // PulseSpigot - OBFHELPER
