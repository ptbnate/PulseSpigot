...
import xyz.krypton.spigot.console.PulseConsole;
// CraftBukkit end
    ...
    protected boolean init() throws IOException {
        Thread thread = new Thread("Server console handler") {
            public void run() {
                ...
                new PulseConsole(DedicatedServer.this).start();
        ...
        //this.p = new EULA(new File("eula.txt")); // PulseSpigot
        // Spigot Start
        boolean eulaAgreed = true; // PulseSpigot
        if ( false && eulaAgreed ) // PulseSpigot
        {
        ...
        // Spigot End
        if (!eulaAgreed) { // Spigot // PulseSpigot
            DedicatedServer.LOGGER.info("You need to agree to the EULA in order to run the server. Go to eula.txt for more info.");
            //this.p.b(); // PulseSpigot
            return false;
        } else {
            if (this.T()) {
                this.c("127.0.0.1");
            ...
            this.server.pulseSpigot.registerCommandsInServer(); // PulseSpigot
            // PulseSpigot end
        ...
        if (!Config.get().settings.lateBind) {
            try {
            ...
            if (!this.getOnlineMode()) {
                ...
                // Spigot start
                if (Config.get().settings.bungeecord) {
            ...
            if (!NameReferencingFileConverter.a(this.propertyManager)) {
                ...
                if (this.server.getBukkitSpawnRadius() > -1) {
                    ...
                    //this.server.removeBukkitSpawnRadius(); // PulseSpigot
