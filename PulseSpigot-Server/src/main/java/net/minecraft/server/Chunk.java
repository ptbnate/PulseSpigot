...
public class Chunk {
    ...
    public final long chunkKey; // PulseSpigot
    private boolean k;
    ...
    private long u;
    private int v;
    //private ConcurrentLinkedQueue<BlockPosition> w; // PulseSpigot - unused
    ...
    public PacketPlayOutMapChunk.ChunkMap getChunkMap(boolean groundUpContinuous, int primaryBitMask) {
        if (!world.paperConfigPulseSpigot.cacheChunkMaps || !groundUpContinuous || (primaryBitMask != 0 && primaryBitMask != '\uffff')) {
    ...
    public Chunk(World world, int i, int j) {
        ...
        this.v = 4096;
        //this.w = Queues.newConcurrentLinkedQueue(); // PulseSpigot - unused
        ...
        this.chunkKey = LongHash.toLong(i, j); // PulseSpigot
    }
                        ...
                        do {
                            ...
                            if (l > 0) {
                                ...
                                if (chunksection != null) {
                                    ...
                                    //this.world.n(new BlockPosition((this.locX << 4) + j, i1, (this.locZ << 4) + k)); // PulseSpigot - unused
                                }
                            }
                ...
                if (i1 < l) {
                    for (l1 = i1; l1 < l; ++l1) {
                        ...
                        if (chunksection != null) {
                            ...
                            //this.world.n(new BlockPosition((this.locX << 4) + i, l1, (this.locZ << 4) + k)); // PulseSpigot - unused
                        }
                    }
                } else {
                    for (l1 = l; l1 < i1; ++l1) {
        ...
        if (iblockdata1 == iblockdata) {
            ...
            if (chunksection.b(i, j & 15, k) != block) {
                ...
                if (flag) {
                    ...
                    if (j1 != k1 && (j1 < k1 || this.getBrightness(EnumSkyBlock.SKY, x, y, z) > 0 || this.getBrightness(EnumSkyBlock.BLOCK, x, y, z) > 0)) { // PulseSpigot
                        this.d(i, k);
                    }
                }
    ...
    public void a(BlockPosition blockposition, TileEntity tileentity) {
        ...
        if (this.getType(blockposition) instanceof IContainer) {
        ...
        } else if (this.world.paperConfigPulseSpigot.removeInvalidMobSpawnerTileEntities && tileentity instanceof TileEntityMobSpawner &&
            ...
            if (this.world.paperConfigPulseSpigot.removeCorruptTileEntities) {
    ...
    // PulseSpigot start - micro optimizations for Chunk#loadNearby
    ...
    public void b(boolean flag) {
        ...
        this.p = true;
        if (!this.lit && this.done && this.world.spigotConfigPulseSpigot.randomLightUpdates) { // Spigot - also use random light updates setting to determine if we should relight
            this.n();
        }
    ...
    public void recheckGaps(final boolean isClientSide) {
        if (!world.paperConfigPulseSpigot.useAsyncLightning) {
            this.h(isClientSide);
            return;
        }
