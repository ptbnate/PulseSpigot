...
public class BlockTripwireHook extends Block {
    ...
    public boolean canPlace(World world, int x, int y, int z, EnumDirection enumdirection) { // PulseSpigot
        return enumdirection.k().c() && world.getType(x, y, z, enumdirection.opposite()).getBlock().isOccluding(); // PulseSpigot
    }

    public boolean canPlace(World world, int x, int y, int z) { // PulseSpigot
        ...
        } while (!world.getType(x, y, z, enumdirection).getBlock().isOccluding()); // PulseSpigot
    ...
    public int b(IBlockAccess iblockaccess, int x, int y, int z, IBlockData iblockdata, EnumDirection enumdirection) { // PulseSpigot
