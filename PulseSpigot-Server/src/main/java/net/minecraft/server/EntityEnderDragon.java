        ...
        if (!this.world.isClientSide) {
            ...
            if (this.by == 1) {
                ...
                for (EntityPlayer player : (List<EntityPlayer>) MinecraftServer.getServer().getPlayerList().players) {
                    ...
                    if ( world.spigotConfigPulseSpigot.dragonDeathSoundRadius > 0 && distanceSquared > MathUtil.pow2(world.spigotConfigPulseSpigot.dragonDeathSoundRadius) ) continue; // Spigot
