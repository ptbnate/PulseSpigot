...
public class EntityItem extends Entity implements HopperPusher {
    ...
    public void t_() {
        if (this.getItemStack() == null) {
            ...
            this.W();
            if (!this.world.isClientSide && this.age >= world.spigotConfigPulseSpigot.itemDespawnRate) { // Spigot
    ...
    private void w() {
        ...
        // Paper end
        // Spigot start
        double radius = world.spigotConfigPulseSpigot.mergeRadius.item;
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            ...
            if (this.pickupDelay <= 0 && canHold > 0) {
                ...
                //itemstack.count = canHold + remaining; // PulseSpigot - moved down
