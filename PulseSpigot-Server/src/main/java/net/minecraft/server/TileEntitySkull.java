...
public class TileEntitySkull extends TileEntity {
    ...
    public static final com.github.benmanes.caffeine.cache.LoadingCache<String, GameProfile> skinCache = com.github.benmanes.caffeine.cache.Caffeine.newBuilder() // PulseSpigot - use caffeine
            .maximumSize( 5000 )
            .expireAfterAccess( 60, TimeUnit.MINUTES )
            .build( new com.github.benmanes.caffeine.cache.CacheLoader<String, GameProfile>() // PulseSpigot - use caffeine
            {
                @Override
            ...
            if (gameprofile.isComplete() && gameprofile.getProperties().containsKey("textures")) {
                ...
                if (profile != null && Iterables.getFirst(profile.getProperties().get("textures"), (Object) null) != null) {
                    ...
                    executor.execute(new Runnable() {
                        @Override
                        public void run() {
                            final GameProfile profile = skinCache.get(gameprofile.getName().toLowerCase()); // PulseSpigot - use caffeine
