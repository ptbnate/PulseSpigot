...
public class PortalTravelAgent {
    ...
    private final it.unimi.dsi.fastutil.longs.Long2ObjectMap<PortalTravelAgent.ChunkCoordinatesPortal> c = new it.unimi.dsi.fastutil.longs.Long2ObjectOpenHashMap(3072, 0.75F); // PulseSpigot - use fastutil map
    ...
    public BlockPosition findPortal(double x, double y, double z, int searchRadius) { // Paper - actually use search radius
        ...
        if (this.c.containsKey(k)) { // PulseSpigot
            PortalTravelAgent.ChunkCoordinatesPortal portaltravelagent_chunkcoordinatesportal = this.c.get(k); // PulseSpigot
    ...
    public void adjustExit(Entity entity, Location position, Vector velocity) {
        Location from = position.fastClone(); // PulseSpigot - Fast Clone
    ...
    public void a(long i) {
        if (i % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                PortalTravelAgent.ChunkCoordinatesPortal portaltravelagent_chunkcoordinatesportal = this.c.get(olong.longValue()); // PulseSpigot
