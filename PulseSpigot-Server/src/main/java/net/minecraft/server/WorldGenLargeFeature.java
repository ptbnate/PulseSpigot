...
public class WorldGenLargeFeature extends StructureGenerator {
    ...
    protected boolean a(int i, int j) {
        ...
        int i1 = i / this.g;
        int j1 = j / this.g;
        Random random = this.c.a(i1, j1, this.c.spigotConfigPulseSpigot.seedFeature); // Spigot
    ...
    public boolean a(BlockPosition blockposition) {
        ...
        if (structurestart != null && structurestart instanceof WorldGenLargeFeature.WorldGenLargeFeatureStart && !structurestart.a.isEmpty()) {
            StructurePiece structurepiece = structurestart.a.get(0); // PulseSpigot - LinkedList -> ArrayList
