...
public class GenericAttributes {
    ...
    // Spigot start
    public static final IAttribute maxHealth = (new AttributeRanged((IAttribute) null, "generic.maxHealth", 20.0D, 0.1D,  Config.get().settings.attribute.maxHealth)).a("Max Health").a(true);
    ...
    public static final IAttribute MOVEMENT_SPEED = (new AttributeRanged((IAttribute) null, "generic.movementSpeed", 0.699999988079071D, 0.0D, Config.get().settings.attribute.movementSpeed)).a("Movement Speed").a(true);
    public static final IAttribute ATTACK_DAMAGE = new AttributeRanged((IAttribute) null, "generic.attackDamage", 2.0D, 0.0D, Config.get().settings.attribute.attackDamage);
    // Spigot end
