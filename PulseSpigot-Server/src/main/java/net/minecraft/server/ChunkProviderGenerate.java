...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.r.r && this.m.paperConfigPulseSpigot.generatorSettings.caves) { // PaperSpigot
            this.u.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.z && this.m.paperConfigPulseSpigot.generatorSettings.canyon) { // PaperSpigot
            this.z.a(this, this.m, i, j, chunksnapshot);
        }

        this.recreateStructures(null, i, j, chunksnapshot); // PulseSpigotj
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        BiomeBase biomebase = this.m.getBiome(k + 16, l + 16); // PulseSpigot
        ...
        if (this.r.w && this.n && this.m.paperConfigPulseSpigot.generatorSettings.mineshaft) { // PaperSpigot
            this.x.a(this.m, this.h, chunkcoordintpair);
        }

        if (this.r.v && this.n && this.m.paperConfigPulseSpigot.generatorSettings.village) { // PaperSpigot
            flag = this.w.a(this.m, this.h, chunkcoordintpair);
        }

        if (this.r.u && this.n && this.m.paperConfigPulseSpigot.generatorSettings.stronghold) { // PaperSpigot
            this.v.a(this.m, this.h, chunkcoordintpair);
        }

        if (this.r.x && this.n && this.m.paperConfigPulseSpigot.generatorSettings.temple) { // PaperSpigot
            this.y.a(this.m, this.h, chunkcoordintpair);
        }

        if (this.r.y && this.n && this.m.paperConfigPulseSpigot.generatorSettings.monument) { // PaperSpigot
        ...
        if (this.r.s && this.m.paperConfigPulseSpigot.generatorSettings.dungeon) { // PaperSpigot
    ...
    // PulseSpigot end
        if (this.r.w && this.n && this.m.paperConfigPulseSpigot.generatorSettings.mineshaft) { // PaperSpigot
            this.x.a(this, this.m, i, j, chunksnapshot); // PulseSpigot
        }

        if (this.r.v && this.n && this.m.paperConfigPulseSpigot.generatorSettings.village) { // PaperSpigot
            this.w.a(this, this.m, i, j, chunksnapshot); // PulseSpigot
        }

        if (this.r.u && this.n && this.m.paperConfigPulseSpigot.generatorSettings.stronghold) { // PaperSpigot
            this.v.a(this, this.m, i, j, chunksnapshot); // PulseSpigot
        }

        if (this.r.x && this.n && this.m.paperConfigPulseSpigot.generatorSettings.temple) { // PaperSpigot
            this.y.a(this, this.m, i, j, chunksnapshot); // PulseSpigot
        }

        if (this.r.y && this.n && this.m.paperConfigPulseSpigot.generatorSettings.monument) { // PaperSpigot
            this.A.a(this, this.m, i, j, chunksnapshot); // PulseSpigot
        }
    }
