...
public class EntityArmorStand extends EntityLiving {
    ...
    public boolean bM() {
        return super.bM() && (this.world.pulseConfig.optimizations.optimizeArmorStands || !this.hasGravity()); // PulseSpigot
    }
    ...
    protected void bL() {
        if (this.world.pulseConfig.optimizations.optimizeArmorStands) return; // PulseSpigot
