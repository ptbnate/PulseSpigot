        ...
        if (!flag && !flag1) {
            ...
            while (iterator.hasNext()) {
                ...
                if (!entityhuman.isSpectator() || !entityhuman.affectsSpawning) { // PaperSpigot
                    ...
                    byte b0 = 8;
                    // Spigot Start
                    b0 = worldserver.spigotConfigPulseSpigot.mobSpawnRange;
                    b0 = ( b0 > worldserver.spigotConfigPulseSpigot.viewDistance ) ? (byte) worldserver.spigotConfigPulseSpigot.viewDistance : b0;
                    b0 = ( b0 > 8 ) ? 8 : b0;
                    // Spigot End
                                    ...
                                    while (true) {
                                        if (i4 < 4) {
                                            label108: {
                                                ...
                                                //k3 += worldserver.random.nextInt(1) - worldserver.random.nextInt(1); // PulseSpigot - unnecessary (always 0)
