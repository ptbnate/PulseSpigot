...
public class Explosion {
    ...
    public void a() {
        ...
        if (!this.world.tacoConfigPulseSpigot.tnt.optimizeLiquidExplosions || !b.getMaterial().isLiquid()) { //TacoSpigot - skip calculating what blocks to blow up in water/lava
        for (int k = 0; k < 16; ++k) {
            for (i = 0; i < 16; ++i) {
                for (j = 0; j < 16; ++j) {
            ...
            if (!entity.aW()) {
                ...
                if (d7 <= 1.0D) {
                    ...
                    if (d11 != 0.0D) {
                        ...
                        // CraftBukkit end
                        double d14 = entity instanceof EntityHuman && world.paperConfigPulseSpigot.disableExplosionKnockback ? 0 : EnchantmentProtection.a(entity, d13); // PaperSpigot
                        ...
                        */
                        ...
                        if (entity instanceof EntityHuman && !((EntityHuman) entity).abilities.isInvulnerable && !world.paperConfigPulseSpigot.disableExplosionKnockback) { // PaperSpigot
    ...
    public void a(boolean flag) {
        ...
        float volume = source instanceof EntityTNTPrimed ? world.paperConfigPulseSpigot.tntExplosionVolume : 4.0F;
        ...
        // PaperSpigot end
        // PulseSpigot start
        if (!this.world.pulseConfig.optimizations.explosionParticles) {
    ...
    private float getBlockDensity(Vec3D vec3d, AxisAlignedBB aabb) {
        if (!this.world.paperConfigPulseSpigot.optimizeExplosions) {
