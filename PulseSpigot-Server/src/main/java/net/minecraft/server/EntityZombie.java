...
public class EntityZombie extends EntityMonster {
    ...
    protected void n() {
        if ( world.spigotConfigPulseSpigot.zombieAggressiveTowardsVillager ) this.goalSelector.a(4, new PathfinderGoalMeleeAttack(this, EntityVillager.class, 1.0D, true)); // Spigot
        ...
        if ( world.spigotConfigPulseSpigot.zombieAggressiveTowardsVillager ) this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityVillager.class, false)); // Spigot
        ...
        if (super.damageEntity(damagesource, f)) {
            ...
            if (entityliving != null && this.world.getDifficulty() == EnumDifficulty.HARD && (double) this.random.nextFloat() < this.getAttributeInstance(EntityZombie.a).getValue()) {
                ...
                for (int l = 0; l < 50; ++l) {
                    ...
                    if (World.a((IBlockAccess) this.world, new BlockPosition(i1, j1 - 1, k1)) && !this.world.isLightLevel(i1, j1, k1, 10)) { // Paper // PulseSpigot
