...
public abstract class StructureGenerator extends WorldGenBase {
    ...
    protected Map<Long, StructureStart> e = new ConcurrentHashMap<>(); // PulseSpigot - ConcurrentHashMap
    ...
    private void a(World world) {
        if (this.d == null) {
            // Spigot Start
            if ( world.spigotConfigPulseSpigot.saveStructureInfo && !this.a().equals( "Mineshaft" ) )
            {
