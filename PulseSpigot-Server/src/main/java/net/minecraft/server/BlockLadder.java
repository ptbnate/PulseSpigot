...
public class BlockLadder extends Block {
    ...
    public boolean canPlace(World world, int x, int y, int z) { // PulseSpigot
        return world.getType(x - 1, y, z).getBlock().isOccluding() || (world.getType(x + 1, y, z).getBlock().isOccluding() || (world.getType(x, y, z - 1).getBlock().isOccluding() || world.getType(x, y, z + 1).getBlock().isOccluding())); // PulseSpigot
    }
