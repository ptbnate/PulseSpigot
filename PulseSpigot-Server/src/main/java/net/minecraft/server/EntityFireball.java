    ...
    public void t_() {
        if (!this.world.isClientSide && (this.shooter != null && this.shooter.dead || !this.world.isLoaded(new BlockPosition(this)))) {
            ...
            if (movingobjectposition != null) {
                ...
                if (this.dead) {
                    CraftEventFactory.callProjectileHitEvent(this, movingobjectposition.entity, movingobjectposition.a(), movingobjectposition.direction); // PulseSpigot - Backport methods
                }
                // CraftBukkit end
            }
