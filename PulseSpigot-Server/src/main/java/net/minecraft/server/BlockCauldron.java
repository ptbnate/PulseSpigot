...
public class BlockCauldron extends Block {
    ...
    public void k(World world, int x, int y, int z) { // PulseSpigot
        if (world.random.nextInt(20) == 1) {
            IBlockData iblockdata = world.getType(x, y, z); // PulseSpigot

            if (((Integer) iblockdata.get(BlockCauldron.LEVEL)).intValue() < 3) {
                world.setTypeAndData(new BlockPosition(x, y, z), iblockdata.a(BlockCauldron.LEVEL), 2); // PulseSpigot
            }
