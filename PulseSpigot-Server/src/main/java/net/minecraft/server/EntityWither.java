        ...
        if (this.cl() > 0) {
            ...
            if (i <= 0) {
                ...
                for (EntityPlayer player : (List<EntityPlayer>) MinecraftServer.getServer().getPlayerList().players) {
                    ...
                    if ( world.spigotConfigPulseSpigot.witherSpawnSoundRadius > 0 && distanceSquared > MathUtil.pow2(world.spigotConfigPulseSpigot.witherSpawnSoundRadius)) continue; // Spigot
