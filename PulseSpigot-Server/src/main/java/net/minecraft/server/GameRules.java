...
public class GameRules {
    ...
    private java.util.Map<String, GameRuleValue> a = new it.unimi.dsi.fastutil.objects.Object2ObjectOpenHashMap<>(); // PaperBin - TreeMap -> HashMap - Faster Game Rules Lookup // PulseSpigot - use fastutil map
