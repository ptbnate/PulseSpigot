...
public abstract class Entity implements ICommandListener {
    ...
    public double motY;
    public double motZ;
    // PulseSpigot start - Movement Cache
    ...
    public AxisAlignedBB boundingBox; // PulseSpigot
    ...
    private double as;
    public boolean ad;
    public KnockbackProfile knockbackProfile = PulseSpigot.get().getKnockbackHandler().getActiveProfile(); // PulseSpigot
    ...
    public Entity(World world) {
        ...
        if (world != null) {
            ...
            // Spigot start
            this.defaultActivationState = org.spigotmc.ActivationRange.initializeEntityActivationState(this, world.spigotConfigPulseSpigot);
        } else {
    ...
    private boolean paperNetherCheck() {
        return this.world.paperConfigPulseSpigot.netherCeilingVoidDamage && this.world.getWorld().getEnvironment() == org.bukkit.World.Environment.NETHER && this.locY >= 128.0D;
    }
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (PulseConfig.get().chunks.disableUnloadedChunksMovement && this.world.isLoaded((int) this.locX, (int) this.locZ)) {
        ...
        if (this.noclip) {
            ...
            boolean axisScan = this.world.tacoConfigPulseSpigot.tnt.optimizeMovement && xLength * yLength * zLength > 10;
            ...
            if (this.world.tacoConfigPulseSpigot.fixEastWestCannoning && Math.abs(d0) > Math.abs(d2)) {
    ...
    public boolean c(NBTTagCompound nbttagcompound) {
        if (!this.world.pulseConfig.settings.saveFireworksAndArrows && (this instanceof EntityFireworks || this instanceof EntityArrow)) return false; // PulseSpigot
        String s = this.ag();
