...
public class ChunkProviderFlat implements IChunkProvider {
    ...
    public ChunkProviderFlat(World world, long i, boolean flag, String s) {
        ...
        if (flag) {
            ...
            if (map.containsKey("village") && world.paperConfigPulseSpigot.generatorSettings.village) { // PaperSpigot
            ...
            if (map.containsKey("biome_1") && world.paperConfigPulseSpigot.generatorSettings.temple) { // PaperSpigot
                this.e.add(new WorldGenLargeFeature((Map) map.get("biome_1")));
            }

            if (map.containsKey("mineshaft") && world.paperConfigPulseSpigot.generatorSettings.mineshaft) { // PaperSpigot
                this.e.add(new WorldGenMineshaft((Map) map.get("mineshaft")));
            }

            if (map.containsKey("stronghold") && world.paperConfigPulseSpigot.generatorSettings.stronghold) { // PaperSpigot
                this.e.add(new WorldGenStronghold((Map) map.get("stronghold")));
            }

            if (map.containsKey("oceanmonument") && world.paperConfigPulseSpigot.generatorSettings.monument) { // PaperSpigot
        ...
        this.g = world.paperConfigPulseSpigot.generatorSettings.dungeon && this.d.b().containsKey("dungeon");  // PaperSpigot
        int j = 0;
        int k = 0;
        boolean flag1 = true;
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        BiomeBase biomebase = this.a.getBiome(k + 16, l + 16); // PulseSpigot
        boolean flag = false;
