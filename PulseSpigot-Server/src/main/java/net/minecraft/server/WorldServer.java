...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    public WorldServer(MinecraftServer minecraftserver, IDataManager idatamanager, WorldData worlddata, int i, MethodProfiler methodprofiler, org.bukkit.World.Environment env, org.bukkit.generator.ChunkGenerator gen) {
        ...
        this.manager = new PlayerChunkMap(this, spigotConfigPulseSpigot.viewDistance); // Spigot
        this.worldProvider.a(this);
        this.chunkProvider = this.k();
        this.Q = ((org.bukkit.craftbukkit.CraftTravelAgent) new org.bukkit.craftbukkit.CraftTravelAgent(this).setSearchRadius(paperConfigPulseSpigot.portalSearchRadius)); // CraftBukkit // Paper - configurable search radius
        this.B();
        this.C();
    ...
    public boolean everyoneDeeplySleeping() {
        ...
        boolean checkOtherDimensions = !PulseConfig.get().settings.sleepingIgnoreOtherDimensions; // PulseSpigot
    ...
    protected void h() {
        // PulseSpigot start
        if (!this.pulseConfig.optimizations.ticking.chunks) {
            return;
        }
        // PulseSpigot end
        super.h();
        if (this.worldData.getType() == WorldType.DEBUG_ALL_BLOCK_STATES) {
           ...
           gnu.trove.iterator.TLongShortIterator iterator = this.chunkTickList.iterator();
            ...
            for (gnu.trove.iterator.TLongShortIterator iter = chunkTickList.iterator(); iter.hasNext(); )
            {
                ...
                if (!this.paperConfigPulseSpigot.disableThunder && this.random.nextInt(100000) == 0 && this.S() && this.R()) { // PaperSpigot - Disable thunder
                ...
                if (!this.paperConfigPulseSpigot.disableIceAndSnow && this.random.nextInt(16) == 0) { // PaperSpigot - Disable ice and snow
                    this.m = this.m * 3 + 1013904223;
                    i1 = this.m >> 2;
        ...
        // Spigot Start
        if ( spigotConfigPulseSpigot.clearTickList )
        {
            chunkTickList.clear();
        }
        // Spigot End
    ...
    public void tickEntities() {
        ...
        super.tickEntities();
        spigotConfigPulseSpigot.currentPrimedTnt = 0; // Spigot
    }
        ...
        if (this.worldData.getType() == WorldType.DEBUG_ALL_BLOCK_STATES) {
            ...
            if (false) { // CraftBukkit
                ...
                if (i > 1000) {
                    ...
                    // CraftBukkit end
                */
                if (i > paperConfigPulseSpigot.tickNextTickListCap) {
                    i = paperConfigPulseSpigot.tickNextTickListCap;
                }
                // PaperSpigot end
                ...
                if (paperConfigPulseSpigot.tickNextTickListCapIgnoresRedstone) {
    ...
    protected IChunkProvider k() {
        ...
        this.chunkProviderServer = new AsyncChunkProvider(this, ichunkloader, gen); // PulseSpigot - Modern Chunks System
        // CraftBukkit end
    ...
    public Explosion createExplosion(Entity entity, double d0, double d1, double d2, float f, boolean flag, boolean flag1) {
        ...
        */
        ...
        if (!this.pulseConfig.optimizations.explosionParticles) return explosion; // PulseSpigot
        Iterator iterator = this.players.iterator();
