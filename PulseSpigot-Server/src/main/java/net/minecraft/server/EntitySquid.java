...
public class EntitySquid extends EntityWaterAnimal {
    ...
    public boolean bR() {
        ...
        return this.locY > this.world.paperConfigPulseSpigot.squidSpawnHeight.minimum && this.locY < (double) this.world.paperConfigPulseSpigot.squidSpawnHeight.maximum && super.bR();
    }
