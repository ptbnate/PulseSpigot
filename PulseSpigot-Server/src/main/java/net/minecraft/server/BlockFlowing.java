...
public class BlockFlowing extends BlockFluids {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        // PulseSpigot start
        if (this.material == Material.WATER && !world.pulseConfig.optimizations.ticking.fluids.water) return;
        if (this.material == Material.LAVA && !world.pulseConfig.optimizations.ticking.fluids.lava) return;
        // PulseSpigot end
        // CraftBukkit start
        ...
        if (i > 0) {
            ...
            if (!world.paperConfigPulseSpigot.fastDrain.lava && this.material == Material.LAVA && i < 8 && i1 < 8 && i1 > i && random.nextInt(4) != 0) { // PaperSpigot
                j *= 4;
            }
    ...
    private void flow(World world, BlockPosition blockposition, IBlockData iblockdata, int i) {
        // PulseSpigot start
        if (this.material == Material.WATER && !world.pulseConfig.optimizations.flow.water) return;
        if (this.material == Material.LAVA && !world.pulseConfig.optimizations.flow.lava) return;
        // PulseSpigot end
    ...
    public int getFlowSpeed(World world, BlockPosition blockposition) {
        if (this.getMaterial() == Material.LAVA) {
            return world.worldProvider.o() ? world.paperConfigPulseSpigot.lavaFlowSpeed.nether : world.paperConfigPulseSpigot.lavaFlowSpeed.normal;
        }
        if (this.getMaterial() == Material.WATER && (
            ...
            return world.paperConfigPulseSpigot.waterOverLavaFlowSpeed;
        }
    ...
    public boolean canFastDrain(World world, BlockPosition position) {
        ...
        if (this.material == Material.WATER) {
            if (world.paperConfigPulseSpigot.fastDrain.water) {
                result = true;
            ...
            if (world.paperConfigPulseSpigot.fastDrain.lava) {
                result = true;
