...
public class ChunkProviderHell implements IChunkProvider {
    ...
    public ChunkProviderHell(World world, boolean flag, long i) {
        this.w = new WorldGenMinable(Blocks.QUARTZ_ORE.getBlockData(), 14, Blocks.NETHERRACK); // PulseSpigot
        ...
        for (int l = 0; l < 16; ++l) {
            for (int i1 = 0; i1 < 16; ++i1) {
                ...
                for (int l1 = 127; l1 >= 0; --l1) {
                    ...
                    if (l1 < 127 - (h.paperConfigPulseSpigot.generatorSettings.flatBedrock ? 0 : this.j.nextInt(5)) &&
                            l1 > (h.paperConfigPulseSpigot.generatorSettings.flatBedrock ? 0 : this.j.nextInt(5))) {
                    // PaperSpigot end
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.h.paperConfigPulseSpigot.generatorSettings.caves) this.C.a(this, this.h, i, j, chunksnapshot); // PaperSpigot
        if (this.i && this.h.paperConfigPulseSpigot.generatorSettings.fortress) { // PaperSpigot
    ...
    public void recreateStructures(Chunk chunk, int i, int j) {
        if (this.h.paperConfigPulseSpigot.generatorSettings.fortress) this.B.a(this, this.h, i, j, (ChunkSnapshot) null); // PaperSpigot
    }
