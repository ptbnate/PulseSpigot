...
public final class SimplePluginManager implements PluginManager {
    ...
    public void registerEvent(Class<? extends Event> event, Listener listener, EventPriority priority, EventExecutor executor, Plugin plugin, boolean ignoreCancelled) {
        ...
        //executor = new co.aikar.timings.TimedEventExecutor(executor, plugin, null, event); // Spigot // PulseSpigot - don't use timings
    ...
    public boolean useTimings() {
        return false; //co.aikar.timings.Timings.isTimingsEnabled(); // Spigot // PulseSpigot - don't use timings
    }
    ...
    public void useTimings(boolean use) {
        //co.aikar.timings.Timings.setTimingsEnabled(use); // Spigot // PulseSpigot - don't use timings
    }
}
