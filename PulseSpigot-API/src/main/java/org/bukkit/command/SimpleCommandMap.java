...
public class SimpleCommandMap implements CommandMap {
    ...
    public boolean register(String label, String fallbackPrefix, Command command) {
        //command.timings = co.aikar.timings.TimingsManager.getCommandTiming(fallbackPrefix, command); // Spigot // PulseSpigot - don't use timings
    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        if (Bukkit.pulse().getConfiguration().disableNamespacedCommands() && sentCommandLabel.contains(":") && !sender.hasPermission("pulse.namespaced")) return false; // PulseSpigot
    ...
    public List<String> tabComplete(CommandSender sender, String cmdLine, Location location) {
        ...
        if (spaceIndex == -1) {
            ...
            for (Map.Entry<String, Command> commandEntry : knownCommands.entrySet()) {
                if (Bukkit.pulse().getConfiguration().disableNamespacedCommands() && commandEntry.getKey().contains(":") && !sender.hasPermission("pulse.namespaced")) continue; // PulseSpigot
