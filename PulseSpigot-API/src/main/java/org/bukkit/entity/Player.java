...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
    ...
    public default void sendMessage(@NotNull net.md_5.bungee.api.chat.BaseComponent component) {
        this.spigot().sendMessage(component); // PulseSpigot
    }
    ...
    public default void sendMessage(@NotNull net.md_5.bungee.api.chat.BaseComponent... components) {
        this.spigot().sendMessage(components); // PulseSpigot
    }
    ...
    public default void sendMessage(@NotNull net.md_5.bungee.api.ChatMessageType position, @NotNull net.md_5.bungee.api.chat.BaseComponent... components) {
        this.spigot().sendMessage(position, components); // PulseSpigot
    }
    // PulseSpigot end
    ...
    public class Spigot extends Entity.Spigot
    {
        ...
        public void sendMessage(@NotNull net.md_5.bungee.api.chat.BaseComponent component) {
            this.sendMessage(net.md_5.bungee.api.ChatMessageType.CHAT, component); // PulseSpigot
        }
        ...
        public void sendMessage(@NotNull net.md_5.bungee.api.chat.BaseComponent... components) {
            this.sendMessage(net.md_5.bungee.api.ChatMessageType.CHAT, components); // PulseSpigot
        }
