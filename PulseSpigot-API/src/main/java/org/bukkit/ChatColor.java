...
public enum ChatColor{
    ...
    public static final char ALT_COLOR_CHAR = '&'; // PulseSpigot
    private static final Pattern STRIP_COLOR_PATTERN = Pattern.compile("(?i)" + COLOR_CHAR + "[0-9A-FK-OR]");
    private static final Pattern DECOLOR_PATTERN = Pattern.compile("(?i)" + COLOR_CHAR + "([0-9A-FK-OR])"); // PulseSpigot
     ...
     */
    public static @NotNull String translateAlternateColorCodes(char altColorChar, @NotNull String textToTranslate) { // PulseSpigot
